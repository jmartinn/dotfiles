...
local fonts    = selector.new({ title = "Font Selector",          subdir = "modules/fonts" })
local leading  = selector.new({ title = "Font Leading Selector",  subdir = "modules/leadings" })
local schemes  = selector.new({ title = "Color Scheme Selector",  subdir = "modules/colorschemes" })
local sizes    = selector.new({ title = "Font Size Selector",     subdir = "modules/sizes" })
local opacity  = selector.new({ title = "Opacity Selector",       subdir = "modules/opacity" })
-- stylua: ignore end
